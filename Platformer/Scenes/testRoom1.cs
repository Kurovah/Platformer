...
{
    public class testRoom1 : Scene
    {
        List<Sprite> sl;
        Player p;
        Cam c;
        public Vector2 playerPos;
        public testRoom1(Game1 _game, ContentManager _content, Vector2 _playerPos):base(_game, _content)
        {
        ...
        public override void Load()
        {
            ...
            sl.Add(new Door(content.Load<Texture2D>("forP"), new Vector2(1000, 416), new Vector2(25, 64), new Vector2(1000, 460), "TestRoom2", game));
            sl.Add(p);
            c = new Cam(p, new Vector2(400, 1200), new Vector2(240, 240));
            c.currentPos = p.pos;
        }
